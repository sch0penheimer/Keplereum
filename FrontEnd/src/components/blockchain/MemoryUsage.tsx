...
const MemoryUsage = () => {
  ...
  return (
    <BlockchainWindow title="MEMORY USAGE & TRANSACTIONS" className="h-full">
      <div className="p-2 h-full grid grid-cols-1 gap-4">
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="bg-satellite-dark p-2 rounded">
            ...
            <div className="text-sm text-white mb-1">10.6 MB / 300 MB</div>
            <div className="w-full bg-gray-700 rounded-full h-2">
              <div className="bg-satellite-accent h-2 rounded-full" style={{ width: '10.6%' }}></div>
            </div>
          </div>
          
          <div className="bg-satellite-dark p-2 rounded">
            <div className="text-xs text-gray-400 mb-1">Unconfirmed</div>
            <div className="text-xl text-white">5,676 <span className="text-xs">TXs</span></div>
          </div>
        </div>
        
        <div className="flex-grow">
          <div className="text-xs text-gray-400 mb-2">Incoming Transactions</div>
          <div className="h-48">
