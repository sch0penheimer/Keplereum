...
class EarthSatelliteApp {
    ...
    */
    ...
    updateSensorCone(satellite) {
        ...
        const altitude = satellitePosition.length() - 4;
        ...
        let baseRadius = (altitude / satellite.orbitParams.maxSensorHeight) * satellite.orbitParams.maxSensorBaseRadius;
        let sensorHeight = altitude;


        // Update the scale of the sensor cone
        satellite.sensorCone.scale.set(baseRadius, sensorHeight < 1 ? 1 : sensorHeight, baseRadius);
        satellite.sensorCone.position.set(0, 0, sensorHeight < 1 ? 0.5 : sensorHeight * 0.5);
    }
